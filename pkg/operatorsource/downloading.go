...
// LoadAuthToken retrieves the authorization token from the specified Secret
// object.
func SetupRegistryOptions(client client.Client, spec *v1alpha1.OperatorSourceSpec) (appregistry.Options, error) {
