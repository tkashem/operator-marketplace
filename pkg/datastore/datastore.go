...
type Writer interface {
	...
	//
	// It's a simplistic implementation that returns true if the remote registry
	// has any update(s). It does not provide specific update information
	// related to each repository:
	...
	//
	// The lack of specific information will force us to reload the entire
	// namespace.
