...
type Writer interface {
	...
	// RegisterOperatorSource registers a new OperatorSource object with the
	// the underlying datastore.
	RegisterOperatorSource(opsrc *v1alpha1.OperatorSource)

	// GetOperatorSource returns true if the Spec of the
	...
	GetOperatorSource(opsrcUID types.UID) (opsrc *v1alpha1.OperatorSourceSpec, ok bool)
}
...
func (ds *memoryDatastore) RegisterOperatorSource(opsrc *v1alpha1.OperatorSource) {
